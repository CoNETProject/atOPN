...
const server = new imapProxyServer ( setup.whiteList, setup.domainListPool, setup.localServerPort, setup.socketPath, setup.checkAgainTimeOut, setup.imapData, setup.connectTimeOut, setup.AllDataToGateway, setup.domainBlackList )